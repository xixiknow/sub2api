export default {
  ...
  auth: {
    ...
    invitationCodeLabel: '注册邀请码',
    invitationCodePlaceholder: '请输入注册邀请码（返佣码或注册码）',
    invitationCodeRequired: '请输入注册邀请码',
    invitationCodeValid: '注册邀请码有效',
    invitationCodeValidWithSeats: '注册邀请码有效，剩余 {seats} 个可用名额',
    invitationCodeInvalid: '注册邀请码无效或已被使用',
    invitationCodeValidating: '正在验证注册邀请码...',
    invitationCodeInvalidCannotRegister: '注册邀请码无效，请检查后重试',
    registrationInviteSeatsEmpty: '邀请名额已用完，请联系邀请人补充名额或更换注册邀请码',
  ...
  affiliate: {
    ...
    stats: {
      rebateRate: '我的返利比例',
      rebateRateHint: '一级用户充值后你可获得的返佣比例',
      invitedUsers: '邀请人数',
    ...
    registrationSeats: {
      title: '注册邀请名额',
      description: '你的返佣码可作为注册邀请码使用；每个新用户注册会消耗 1 个名额。',
      available: '可用名额',
      used: '已用名额',
      total: '累计名额',
      cost: '单个名额',
      ...
      purchase: '购买名额',
      purchasing: '购买中...',
      statusAvailable: '邀请链接可注册',
      statusEmpty: '名额已用完',
      freeModeTitle: '当前无需购买注册邀请名额',
      freeModeDescription: '管理员已将注册邀请名额成本设为 0，你的邀请码默认可用于注册，不会消耗名额。',
      balanceHint: '当前余额：{balance}，购买会立即从余额扣除。',
      invalidQuantity: '请输入有效的购买数量',
      purchaseSuccess: '已购买 {count} 个注册邀请名额，扣费 {amount}',
      purchaseFailed: '购买注册邀请名额失败'
    },
    levelRules: {
      title: '三级返佣规则',
      description: '当前生效比例会直接用于后续订单返佣，一级可由管理员配置专属比例。',
      levelTitle: '{level} 级返佣',
      level1Hint: '你直接邀请的用户充值时产生。',
      level2Hint: '一级用户邀请的新用户充值时产生。',
      level3Hint: '二级用户继续邀请的新用户充值时产生。',
      sourceExclusive: '专属比例',
      sourceGlobal: '全局比例',
      sourceLocked: '未解锁'
    },
    rebateGuide: {
      eyebrow: '返利规则',
      title: '返利规则与升级进度',
      subtitle: '邀请链路、比例和解锁门槛会在这里同步展示；二级、三级未解锁前不会产生对应返利。',
      invitedLabel: '有效邀请人数',
      totalInvites: '累计注册 {count} 人',
      finalGoalLabel: '三级解锁目标',
      mechanicsTitle: '返利怎么产生',
      autoSettle: '订单自动结算',
      level1Title: '一级：直接邀请',
      level1Description: '新用户通过你的返佣码或邀请链接注册并充值，按一级比例返利。',
      level2Title: '二级：下级继续邀请',
      level2Description: '你的一级用户再邀请的新用户充值；你达到有效邀请门槛后，按二级比例返利。',
      level3Title: '三级：团队链路延伸',
      level3Description: '二级用户继续邀请的新用户充值；你达到更高有效邀请门槛后，按三级比例返利。',
      rateValue: '生效比例 {rate}',
      lockedRateLabel: '达标后生效',
      flowTitle: '额度流转',
      flowInvite: '分享链接注册',
      flowRecharge: '被邀请用户充值',
      flowFreeze: '进入冻结期',
      flowTransfer: '解冻后转余额',
      progressTitle: '当前解锁进度',
      progressSubtitle: '解锁只看直属有效邀请：被邀请用户完成真实支付订单后计入，未支付和纯注册不计。',
      nextGoal: '再完成 {count} 个有效邀请解锁 {level} 级',
      allUnlocked: '三级已全部解锁',
      alwaysOnProgress: '默认拥有',
      inviteProgress: '邀请进度',
      availableNow: '已生效',
      progressValue: '{current}/{target} 人',
      level1Requirement: '账号创建后默认拥有一级返利；管理员可给你配置专属一级比例。',
      levelUnlockRequirement: '直属有效邀请累计达到 {count} 人后解锁 {level} 级返利。',
      unlocked: '已解锁',
      locked: '待解锁'
    },
    transfer: {
    ...
    tips: {
      title: '使用说明',
      line1: '将返佣码或邀请链接分享给新用户。',
      line2: '一级用户充值后，你可获得 {rate} 的返佣额度。',
      line3: '邀请链接需要有可用注册名额，注册成功会自动消耗 1 个名额。',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          registrationSeatCost: '注册邀请码名额单价',
          registrationSeatCostDesc: '用户购买 1 个注册邀请码名额需要扣除的余额。支持 0，表示免费领取名额。',
          customUsers: {
            title: '专属用户配置',
      ...
      site: {
        ...
        communityTitle: '社群入口',
        communityDescription: '用于成长中心的新手任务，展示 QQ 群二维码或社群入口链接。',
        communityImage: '社群图片',
        communityImageHint: '建议上传 QQ 群二维码或社群海报，最大 600KB。',
        communityLink: '社群链接',
        communityLinkHint: '填写 QQ 群邀请链接或社群落地页链接，留空则不展示按钮。',
