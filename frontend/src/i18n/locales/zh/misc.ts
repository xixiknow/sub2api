export default {
  ...
  payment: {
    ...
    rechargeBonus: '活动赠送',
    rechargeBonusTitle: '充值赠礼',
    rechargeBonusDesc: '满足档位后自动赠送到账余额',
    rechargeBonusMatched: '当前已命中',
    rechargeBonusFixed: '充 ¥{min} 送 ${bonus}',
    rechargeBonusPercent: '充 ¥{min} 送 {percent}%',
    rechargeBonusFixedPercent: '充 ¥{min} 送 ${bonus} + {percent}%',
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
