export default {
  ...
  affiliate: {
    ...
    registrationSeats: {
      ...
      freeModeTitle: 'Registration invite seats are not required',
      freeModeDescription: 'The admin set registration invite seat cost to 0. Your invite code can be used for registration without consuming seats.',
    ...
    rebateGuide: {
      eyebrow: 'Rebate Rules',
      title: 'Rebate Rules and Upgrade Progress',
      subtitle: 'Your invite chain, effective rates, and unlock requirements are shown here. Level 2 and level 3 rebates do not accrue until unlocked.',
      invitedLabel: 'Qualified invites',
      totalInvites: '{count} total registrations',
      finalGoalLabel: 'Level 3 goal',
      mechanicsTitle: 'How rebates accrue',
      autoSettle: 'Orders settle automatically',
      level1Title: 'Level 1: Direct invite',
      level1Description: 'A new user registers through your affiliate code or invite link and recharges. You earn the level-1 rate.',
      level2Title: 'Level 2: Invitee invites',
      level2Description: 'A user invited by your level-1 user recharges. After you reach the qualified-invite threshold, you earn the level-2 rate.',
      level3Title: 'Level 3: Extended chain',
      level3Description: 'A user invited by your level-2 user recharges. After you reach the higher qualified-invite threshold, you earn the level-3 rate.',
      rateValue: 'Effective rate {rate}',
      lockedRateLabel: 'Effective after unlock',
      flowTitle: 'Quota flow',
      flowInvite: 'Share link',
      flowRecharge: 'Invitee recharges',
      flowFreeze: 'Pending freeze',
      flowTransfer: 'Transfer after release',
      progressTitle: 'Current unlock progress',
      progressSubtitle: 'Unlocks use direct qualified invites: an invitee counts after completing a real paid order. Unpaid registrations do not count.',
      nextGoal: 'Complete {count} more qualified invites to unlock level {level}',
      allUnlocked: 'All three levels unlocked',
      alwaysOnProgress: 'Default access',
      inviteProgress: 'Invite progress',
      availableNow: 'Active',
      progressValue: '{current}/{target} users',
      level1Requirement: 'Level 1 rebates are available by default after account creation. Admins may assign you an exclusive level-1 rate.',
      levelUnlockRequirement: 'Unlock level {level} rebates after {count} direct qualified invites.',
      unlocked: 'Unlocked',
      locked: 'Locked'
    },
    transfer: {
  ...
  admin: {
    ...
    growth: {
      ...
      description: 'Configure automatic rate and affiliate benefits triggered by badges'
    },
    ...
    settings: {
      ...
      site: {
        ...
        communityTitle: 'Community Entry',
        communityDescription: 'Shown in the starter task inside Growth Center, usually as a QQ group QR code or community invite link.',
        communityImage: 'Community Image',
        communityImageHint: 'Upload a QQ group QR code or community poster. Max 600KB.',
        communityLink: 'Community Link',
        communityLinkHint: 'QQ invite link or community landing page. Leave empty to hide the button.',
        communityLinkPlaceholder: 'https://qm.qq.com/...',
        siteLogo: 'Site Logo',
  ...
  payment: {
    ...
    rechargeBonus: 'Promotion Bonus',
    rechargeBonusTitle: 'Recharge Bonus',
    rechargeBonusDesc: 'Matched tiers add bonus balance automatically',
    rechargeBonusMatched: 'Matched',
    rechargeBonusFixed: 'Pay ¥{min}, get ${bonus}',
    rechargeBonusPercent: 'Pay ¥{min}, get {percent}%',
    rechargeBonusFixedPercent: 'Pay ¥{min}, get ${bonus} + {percent}%',
