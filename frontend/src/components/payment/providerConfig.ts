...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  dulupay: '/api/v1/payment/webhook/dulupay',
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  dulupay: { notifyUrl: WEBHOOK_PATHS.dulupay, returnUrl: RETURN_PATH },
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  dulupay: [
    ...
    { key: 'apiBase', label: '', sensitive: false, defaultValue: 'https://api.dulupay.com' },
  ],
  alipay: [
