...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/video-workbench', label: t('nav.videoWorkbench'), icon: VideoCatalogIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/video-assets', label: t('nav.videoAssets'), icon: VideoCatalogIcon, hideInSimpleMode: true },
