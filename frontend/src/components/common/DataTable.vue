<template>
  <div v-if="!isDesktopViewport" class="space-y-3">
    <template v-if="loading">
      <div v-for="i in 5" :key="i" class="rounded-lg border border-terra-line bg-terra-elevated p-4 shadow-glass-sm dark:border-dark-700 dark:bg-dark-900">
        <div class="space-y-3">
    ...
    <template v-else-if="!data || data.length === 0">
      <div class="rounded-lg border border-terra-line bg-terra-elevated p-12 text-center shadow-glass-sm dark:border-dark-700 dark:bg-dark-900">
        <slot name="empty">
    ...
    <template v-else>
      ...
      <div
        ...
        class="rounded-lg border border-terra-line bg-terra-elevated p-4 shadow-glass-sm dark:border-dark-700 dark:bg-dark-900"
        :class="{
      ...
      >
        <div class="space-y-3">
          ...
          >
            <span class="text-xs font-medium uppercase tracking-wider text-terra-muted dark:text-dark-400">
              {{ column.label }}
            </span>
            <div class="min-w-0 max-w-full text-right text-sm text-terra-ink dark:text-gray-100">
  ...
  <div
    v-else
    ref="tableWrapperRef"
    class="table-wrapper rounded-lg border border-terra-line bg-terra-elevated shadow-glass-sm dark:border-dark-700 dark:bg-dark-900"
    :class="{
      'actions-expanded': actionsExpanded,
      'is-scrollable': isScrollable
    }"
  >
    <table class="w-full min-w-max divide-y divide-terra-line dark:divide-dark-700">
      <thead class="table-header bg-terra-surface dark:bg-dark-800">
        <tr>
          <th
            v-if="selectable"
            scope="col"
          ...
          <th
            ...
            :class="[
              'sticky-header-cell py-3 text-left text-xs font-medium uppercase tracking-wider text-terra-muted dark:text-dark-400',
              getAdaptivePaddingClass(),
              { 'cursor-pointer hover:bg-terra-sunken dark:hover:bg-dark-700': column.sortable },
      ...
      <tbody class="table-body divide-y divide-terra-line/80 bg-terra-elevated dark:divide-dark-700 dark:bg-dark-900">
        <!-- Loading skeleton -->
        ...
        <template v-else>
          ...
          <tr
            ...
            class="hover:bg-terra-surface dark:hover:bg-dark-800"
            :class="{
              'cursor-pointer': clickableRows,
          ...
          >
            ...
            <td
              ...
              :key="column.key"
              :class="[
                'whitespace-nowrap py-4 text-sm text-terra-ink dark:text-gray-100',
                getAdaptivePaddingClass(),
