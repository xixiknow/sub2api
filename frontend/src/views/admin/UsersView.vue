    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-usage_drama="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'drama')" />
          </template>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_drama', label: 'Drama Usage', sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_drama',
...
const VERSION_NEW_HIDDEN_COLUMNS: Record<number, string[]> = {
  2: ['usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_drama'],
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_drama']
