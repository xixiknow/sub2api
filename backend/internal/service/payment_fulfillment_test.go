...
func (r *paymentFulfillmentAffiliateRepoStub) AccrueQuota(_ context.Context, inviterID, inviteeUserID int64, amount float64, freezeHours int, sourceOrderID *int64, _ int, _ float64) (bool, error) {
...
func (r *paymentFulfillmentAffiliateRepoStub) ClawbackQuotaForOrder(context.Context, int64, float64) (AffiliateClawbackResult, error) {
	panic("unexpected ClawbackQuotaForOrder call")
}

func (r *paymentFulfillmentAffiliateRepoStub) ConsumeRegistrationInviteSeat(context.Context, string, int64) (*AffiliateRegistrationInvite, error) {
	panic("unexpected ConsumeRegistrationInviteSeat call")
}

func (r *paymentFulfillmentAffiliateRepoStub) RestoreRegistrationInviteSeat(context.Context, string, int64) error {
	panic("unexpected RestoreRegistrationInviteSeat call")
}

func (r *paymentFulfillmentAffiliateRepoStub) GetRegistrationInviteByCode(context.Context, string) (*AffiliateRegistrationInvite, error) {
	panic("unexpected GetRegistrationInviteByCode call")
}

func (r *paymentFulfillmentAffiliateRepoStub) PurchaseRegistrationSeats(context.Context, int64, int, float64) (*AffiliateRegistrationSeatPurchaseResult, error) {
	panic("unexpected PurchaseRegistrationSeats call")
}
...
func (r *paymentFulfillmentAffiliateRepoStub) GetLevelDetails(context.Context, int64, int) ([]AffiliateLevelDetail, error) {
	panic("unexpected GetLevelDetails call")
}

func (r *paymentFulfillmentAffiliateRepoStub) GetLevelRebateSummary(context.Context, int64) ([]AffiliateLevelRebateSummary, error) {
	panic("unexpected GetLevelRebateSummary call")
}
