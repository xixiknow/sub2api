...
var ProviderSet = wire.NewSet(
	...
	NewDramaVideoService,
	NewSeedanceVideoService,
	wire.Bind(new(APIKeyQuotaUpdater), new(*APIKeyService)),
	wire.Bind(new(apiKeyAuthCacheInvalidator), new(*APIKeyService)),
