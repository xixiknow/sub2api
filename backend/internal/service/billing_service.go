...
func (s *BillingService) getDefaultVideoPrice(model string, resolution string) float64 {
	...
	// TODO: Drama video pricing - uncomment when constants are defined
...
// TODO: Drama video pricing - uncomment when constants are defined
/*
func getDefaultDramaVideoPrice(model string, resolution string) (float64, bool) {
	switch CanonicalVideoPriceFamily(model) {
	case VideoPriceFamilyDramaVideoV2Fast:
		switch NormalizeVideoBillingResolutionOrDefault(resolution) {
		case VideoBillingResolution480P:
			return defaultDramaVideoV2FastPrice480P, true
		case VideoBillingResolution720P, VideoBillingResolution1080P:
			return defaultDramaVideoV2FastPrice720P, true
		default:
			return defaultDramaVideoV2FastPrice720P, true
		}
	case VideoPriceFamilyDramaVideoV2:
		switch NormalizeVideoBillingResolutionOrDefault(resolution) {
		case VideoBillingResolution480P:
			return defaultDramaVideoV2Price480P, true
		case VideoBillingResolution720P:
			return defaultDramaVideoV2Price720P, true
		case VideoBillingResolution1080P:
			return defaultDramaVideoV2Price1080P, true
		default:
			return defaultDramaVideoV2Price720P, true
		}
	default:
