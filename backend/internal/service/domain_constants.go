...
const (
	...
	// Affiliate level settings
	AffiliateLevelsMax                      = 3     // 最大返利层级
	AffiliateRegistrationSeatCostDefault    = 0.0   // 返佣注册链接注册名额单价默认值（0 = 不收费）
	AffiliateLevel2UnlockInviteCount        = 5     // 解锁二级返利需要的有效邀请人数
	AffiliateLevel3UnlockInviteCount        = 10    // 解锁三级返利需要的有效邀请人数
)
...
const (
	...
	SettingKeyAffiliateLevelRates                 = "affiliate_level_rates"            // 多级返利比例（JSON数组，如 [5,1,0.5]）
