...
func NormalizeVisibleMethodSource(method, source string) string {
	...
	case payment.TypeAlipay:
		...
		case VisibleMethodSourceDulupayAlipay, payment.TypeDulupay:
			return VisibleMethodSourceDulupayAlipay
		}
	case payment.TypeWxpay:
		...
		case VisibleMethodSourceDulupayWechat, payment.TypeDulupay:
			return VisibleMethodSourceDulupayWechat
		}
	}
	return ""
}
...
func VisibleMethodProviderKeyForSource(method, source string) (string, bool) {
	...
	case VisibleMethodSourceDulupayAlipay:
		return payment.TypeDulupay, NormalizeVisibleMethod(method) == payment.TypeAlipay
	...
	case VisibleMethodSourceDulupayWechat:
		return payment.TypeDulupay, NormalizeVisibleMethod(method) == payment.TypeWxpay
	default:
		return "", false
	}
}
