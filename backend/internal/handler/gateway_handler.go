...
func (h *GatewayHandler) Models(c *gin.Context) {
	...
	if platform == service.PlatformDrama {
		writeModelsList(c, service.PlatformDrama, []string{service.DramaVideoModelV2Fast, service.DramaVideoModelV2})
		return
	}
...
func defaultModelIDsForPlatform(platform string) []string {
	...
	case service.PlatformDrama:
		return []string{service.DramaVideoModelV2Fast, service.DramaVideoModelV2}
