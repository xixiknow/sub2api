...
func (r *oauthEmailAffiliateRepoStub) ClawbackQuotaForOrder(context.Context, int64, float64) (service.AffiliateClawbackResult, error) {
	panic("unexpected ClawbackQuotaForOrder call")
}

func (r *oauthEmailAffiliateRepoStub) GetRegistrationInviteByCode(_ context.Context, code string) (*service.AffiliateRegistrationInvite, error) {
	userID, ok := r.codeOwners[strings.ToUpper(strings.TrimSpace(code))]
	if !ok {
		return nil, service.ErrAffiliateProfileNotFound
	}
	return &service.AffiliateRegistrationInvite{
		UserID:                    userID,
		AffCode:                   strings.ToUpper(strings.TrimSpace(code)),
		RegistrationSeatAvailable: 1,
	}, nil
}

func (r *oauthEmailAffiliateRepoStub) ConsumeRegistrationInviteSeat(context.Context, string, int64) (*service.AffiliateRegistrationInvite, error) {
	panic("unexpected ConsumeRegistrationInviteSeat call")
}

func (r *oauthEmailAffiliateRepoStub) RestoreRegistrationInviteSeat(context.Context, string, int64) error {
	panic("unexpected RestoreRegistrationInviteSeat call")
}

func (r *oauthEmailAffiliateRepoStub) PurchaseRegistrationSeats(context.Context, int64, int, float64) (*service.AffiliateRegistrationSeatPurchaseResult, error) {
	panic("unexpected PurchaseRegistrationSeats call")
}

func (r *oauthEmailAffiliateRepoStub) GetLevelRebateSummary(context.Context, int64) ([]service.AffiliateLevelRebateSummary, error) {
	panic("unexpected GetLevelRebateSummary call")
}

func (r *oauthEmailAffiliateRepoStub) GetLevelDetails(context.Context, int64, int) ([]service.AffiliateLevelDetail, error) {
