...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dramaVideoRepository := repository.NewDramaVideoRepository(db)
	dramaVideoClient := repository.NewDramaVideoClient(configConfig)
	dramaVideoService := service.NewDramaVideoService(dramaVideoRepository, accountRepository, dramaVideoClient, billingService, usageBillingRepository, usageLogRepository, userGroupRateRepository, apiKeyService, apiKeyAuthCacheInvalidator, modelPricingResolver)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, tgShopWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, dramaVideoHandler, idempotencyCoordinator, idempotencyCleanupService)
